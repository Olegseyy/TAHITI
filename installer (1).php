...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'tahiti_12f39def3827ad132553_20220719072200_archive.zip';
	const ARCHIVE_SIZE		 = '38436613';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '12f39de-19072200';
    const SECONDARY_PACKAGE_HASH = '27be7be-19072200';
	const VERSION			 = '1.4.7';
